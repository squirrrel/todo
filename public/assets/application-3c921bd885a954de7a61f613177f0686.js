...
jQuery.support = (function( support ) {
	...
	a.style.cssText = "top:1pxfloat:leftopacity:.5"
	...
	jQuery(function() {
		var container, marginDiv, tds,
			divReset = "padding:0margin:0border:0display:blockbox-sizing:content-box-moz-box-sizing:content-box-webkit-box-sizing:content-box",
		...
		container.style.cssText = "border:0width:0height:0position:absolutetop:0left:-9999pxmargin-top:1px"
		...
		tds[ 0 ].style.cssText = "padding:0margin:0border:0display:none"
		...
		div.innerHTML = ""
		div.style.cssText = "box-sizing:border-box-moz-box-sizing:border-box-webkit-box-sizing:border-boxpadding:1pxborder:1pxdisplay:blockwidth:4pxmargin-top:1%position:absolutetop:1%"
		...
		if ( typeof div.style.zoom !== core_strundefined ) {
			...
			// them layout
			div.innerHTML = ""
			div.style.cssText = divReset + "width:1pxpadding:1pxdisplay:inlinezoom:1"
...
function triggerOnCancel(obj, task_id) {
var injection = $(obj).attr('id') + '_span'
var description_id = 'description' + injection
var priority_id = 'priority'+ injection
...
function triggerOnOk(obj, task_id, dropdown) {
$('div#description' + task_id).attr('contenteditable','false')

var selected_1 = $('select :selected').slice(1,2).text()
var selected_2 = $('select :selected').slice(2,3).text() 
...
function triggerOnEdit(task_id, dropdown){
$('div#description' + task_id).attr('contenteditable','true')
$('div#priority' + task_id).replaceWith('<div>
<select><option>high</option><option>medium</option><option>low</option></select></div>')
$('div#status' + task_id).replaceWith('<select><option>open</option><option>in progress</option></select>')
$('#' + dropdown +'.okay' + task_id).show()
}


(function() {
  jQuery(function() {
    return $('.testing').onchange(function() {
      return $('.add_me').click()
    })
  })
