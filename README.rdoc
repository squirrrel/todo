...
* Implement advanced caching IN PROGRESS
...
* Add black tooltips where needed RELEASE 2
...
* Change domain to accept the settings.yml info somehow for smtp

* Check production settings against their adequacy with ideal version

* Fix translation

* Fix 500 at resetting password DONE

* Customize error 500 for prod

* Look what is wrong with caching

* use Rack::Static, :urls => ["*.png", "*.jpg", "*.js", "*.css"], :root => "public" did not improve the app speed
