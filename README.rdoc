...
* Add sorting functionality IN PROGRESS - yet to handle completed_at sorting

* Add black tooltips where needed IN PROGRESS

* Add new_task form validations

* 500 error notification handler

* Refactor coffee files

* Calculate validation height based on the target height 
