...
* Fix post-create CSS, add complete/reopen items to corresponding table using jquery

* Implement advanced Filter

* Implement Resizing and modify description text position and stuff

* Add user name at the top on the left
